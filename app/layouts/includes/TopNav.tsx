                ...
                <div className={`flex items-center justify-between gap-6 w-full px-4 mx-auto ${pathname === '/' ? 'max-w-[1150px]' : ''}`}>
                    ...
                    <Link href="/">
                        <div className="flex items-center">
                            ...
                            <img className="w-12" src="/images/logo.png" /> <span className="lg:text-3xl text-lg ml-2 font-bold "> Saddam <span className="text-rose-600">Reels</span> </span>
                        </div>
                    </Link>
                    ...
                    <div className="flex items-center gap-3 ">
                        ...
                        {!userContext?.user?.id ? (
                            ...
                            <div className="flex items-center">
                                <button
                                    onClick={() => goTo()}
                                    className="flex items-center border mr-1 lg:mr-4 rounded-sm py-[6px] hover:bg-gray-100 pl-1.5"
                                >
