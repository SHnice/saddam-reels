            ...
            <div id={`PostMain-${post.id}`} className="flex border-b pb-6">
                ...
                <div className="lg:pl-3 pl-0 w-full px-4">
                    ...
                    <div className="mt-2.5 flex">
                        <div
                            className="relative w-[300px] min-h-[480px] max-h-[580px] max-w-[260px] flex items-center bg-black rounded-xl cursor-pointer"
                        >
                            <video
                                id={`video-${post.id}`}
                                loop
